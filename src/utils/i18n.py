TRANSLATIONS = {
    "en": {
        ...
        "dashboard": {
            ...
            "boost": "BOOST MODE (High Performance)",
            ...
            "use_gpu": "ENABLE GPU ACCELERATOR",
            "no_gpu": "GPU ACCELERATOR (Not Supported/Found)",
            "hw_strategy": "HARDWARE STRATEGY",
            "hybrid_mode": "HYBRID CLUSTER (CPU + GPU Support)",
...
"""
    ...
    "km": {
        ...
        "dashboard": {
            ...
            "boost": "របៀបបង្កើនល្បឿន (ប្រសិទ្ធភាពខ្ពស់)",
            ...
            "use_gpu": "បើកដំណើរការឧបករណ៍បង្កើនល្បឿន GPU",
            "no_gpu": "ឧបករណ៍បង្កើនល្បឿន GPU (មិនគាំទ្រ)",
            "hw_strategy": "យុទ្ធសាស្ត្រគ្រឿងរឹង",
            "hybrid_mode": "របៀបកាត់ (CPU + GPU)",
